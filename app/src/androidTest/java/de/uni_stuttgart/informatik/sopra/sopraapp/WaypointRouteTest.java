...
public class WaypointRouteTest {
    ...
    public void useAppContext() {
        ...
        onView(withText("OK")).perform(click());
        onData(hasToString(startsWith(""))).inAdapterView(withId(R.id.selectedWaypointList)).atPosition(0).check(matches(withText("2: Eingang Pos 539.5;886.5, NoteHier geht es los, ")));
        onData(hasToString(startsWith(""))).inAdapterView(withId(R.id.selectedWaypointList)).atPosition(1).check(matches(withText("2: Schatzkammer Pos 539.5;886.5, NoteNichts mitgehen lassen!, ")));
        onData(hasToString(startsWith(""))).inAdapterView(withId(R.id.selectedWaypointList)).atPosition(3).check(matches(withText("4: Ausgang Pos 539.5;886.5, NoteJetzt aber raus hier, ")));
        onData(hasToString(startsWith(""))).inAdapterView(withId(R.id.selectedWaypointList)).atPosition(4).check(matches(withText("4: Ausgang Pos 539.5;886.5, NoteJetzt aber raus hier, ")));
